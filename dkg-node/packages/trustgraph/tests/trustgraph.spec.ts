...
import trustgraphPlugin from "../dist/index.js";
import {
  createExpressApp,
...
describe("@dkg/trustgraph checks", function () {
  ...
  beforeEach(async () => {
    ...
    // Initialize plugin
    trustgraphPlugin(mockDkgContext, mockMcpServer, apiRouter);
    await connect();
    app.use("/", apiRouter);
  });
  ...
  describe("Plugin Configuration", () => {
    it("should create plugin without errors", () => {
      expect(trustgraphPlugin).to.be.a("function");
    });
  });
